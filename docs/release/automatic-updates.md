...
The current source release target is `0.1.3`.
...
```sh
UPDATE_BASE_URL="https://downloads.example.org/0wl" XPI_FILE="0wl-0.1.3.xpi" npm run updates:manifest
```
...
https://downloads.example.org/0wl/0wl-0.1.3.xpi
```
