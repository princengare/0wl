...
export const SCHEDULED_BREAK_RUNTIME_STATE_STORAGE_KEY = "scheduledBreakRuntimeState";
export const LOCAL_SYNC_DEVICE_ID_STORAGE_KEY = "localSyncDeviceId";
export const LOCAL_SYNC_DIAGNOSTICS_STORAGE_KEY = "localSyncDiagnostics";
...
export const SCHEDULED_BREAK_ALARM_NAME = "scheduled-break-check";
...
export const DEFAULT_SCHEDULED_BREAK_DURATION_MINUTES = 5;
export const SCHEDULED_BREAK_EARLY_END_AFTER_MS = 5 * 60 * 1000;
